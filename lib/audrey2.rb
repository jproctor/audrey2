...
# Prep SimpleRSS to deal with Atom enclosures
class SimpleRSS
  @@item_tags << :'link+enclosure'
end

# Monkeypatch FeedNormalizer to deal with Atom enclosures
  ...
  class SimpleRssParser
    ...
    def self.package(atomrss)
      ...
      entry_mapping = {
        ...
        :urls => :link,
        :enclosures => [:enclosure, :'link+enclosure'],
